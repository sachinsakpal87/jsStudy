...
http.put('https://jsonplaceholder.typicode.com/users/10',user).then((data)=> console.log(data));

http.delete('https://jsonplaceholder.typicode.com/users/11').then((data)=> console.log(data));